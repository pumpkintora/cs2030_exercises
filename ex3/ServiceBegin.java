class ServiceBegin extends BankEvent {
    ...
    public String toString() {
        String str = "";
        str = String.format(": " + this.getCustomer().toString() + " " + this.getCustomer().getTask().toString() + " begin (by " + this.getCounter().toString() + ")");
        this.getCustomer().getTask().performTask(this.getCounter());
